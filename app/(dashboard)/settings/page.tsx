      ...
      <Tabs defaultValue="general" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="company-name" defaultValue="E-commerce SARL" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="company-email">Email</Label>
                <Input id="company-email" type="email" defaultValue="contact@ecommerce.fr" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="company-phone">Téléphone</Label>
                <Input id="company-phone" type="tel" defaultValue="+33 1 23 45 67 89" />
              </div>
              <div className="space-y-2">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Recevoir une alerte quand un produit atteint le stock minimum
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Notification pour chaque nouvelle commande</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">Alerte pour les paiements non reçus</p>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Livraisons fournisseurs</Label>
                  <p className="text-sm text-muted-foreground">
                    Notification lors de la réception de commandes fournisseurs
                  </p>
                </div>
                <Switch />
              </div>
        ...
        <TabsContent value="users" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                La gestion des utilisateurs et des rôles sera disponible prochainement.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
